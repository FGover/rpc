package com.fg.serializer;

import com.fg.config.ObjectWrapper;
import com.fg.serializer.service.impl.HessianSerializer;
import com.fg.serializer.service.impl.JdkSerializer;
import com.fg.serializer.service.impl.JsonSerializer;
...
public class SerializerFactory {
    ...
    public static ObjectWrapper<Serializer> getSerializer(Byte serializeCode) {
        ...
        if (serializerWrapper == null) {
            log.warn("未找到您配置的{}序列化工具，默认选用jdk的序列化方式", serializeCode);
            return getDefaultSerializer();
        }
        return serializerWrapper;
    }
